...
tf.flags.DEFINE_integer('embedding_dim', '100', 'embedding矩阵的维度')
...
if __name__ == '__main__':
    ...
    print('Train...')
    model.fit(x_train, y_train, batch_size=64, validation_data=[x_dev, y_dev], epochs=5, callbacks=[tf_board_callback])
